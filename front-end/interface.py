...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.header_frame.setFixedSize(QSize(960, 120))
        ...
        self.upload_label = QLabel("Drop Image Here -or- Click to Upload")
        ...
        chat_display.setStyleSheet("background-color: #44475A; color: white;")
        ...
        main_layout.addWidget(self.header_frame, alignment=Qt.AlignmentFlag.AlignCenter) 
